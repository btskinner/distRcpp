...
// dist_1to1
double dist_1to1(const double& xlon, const double& xlat, const double& ylon, const double& ylat, const std::string dist_function);
...
// dist_1tom
Rcpp::NumericVector dist_1tom(const double& xlon, const double& xlat, const Rcpp::NumericVector& ylon, const Rcpp::NumericVector& ylat, const std::string dist_function);
...
// dist_mtom
Rcpp::NumericMatrix dist_mtom(const Rcpp::NumericVector& xlon, const Rcpp::NumericVector& xlat, const Rcpp::NumericVector& ylon, const Rcpp::NumericVector& ylat, const std::string dist_function);
...
// dist_df
Rcpp::NumericVector dist_df(const Rcpp::NumericVector& xlon, const Rcpp::NumericVector& xlat, const Rcpp::NumericVector& ylon, const Rcpp::NumericVector& ylat, const std::string dist_function);
...
// dist_max
Rcpp::DataFrame dist_max(Rcpp::DataFrame x_df, Rcpp::DataFrame y_df, const std::string& x_id, const std::string& y_id, const std::string& x_lon_col, const std::string& x_lat_col, const std::string& y_lon_col, const std::string& y_lat_col, const std::string& dist_function);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::string& >::type x_id(x_idSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type y_id(y_idSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type x_lon_col(x_lon_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type x_lat_col(x_lat_colSEXP);
...
// dist_min
Rcpp::DataFrame dist_min(Rcpp::DataFrame x_df, Rcpp::DataFrame y_df, const std::string& x_id, const std::string& y_id, const std::string& x_lon_col, const std::string& x_lat_col, const std::string& y_lon_col, const std::string& y_lat_col, const std::string& dist_function);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::DataFrame& >::type x_df(x_dfSEXP);
    Rcpp::traits::input_parameter< Rcpp::DataFrame& >::type y_df(y_dfSEXP);
    Rcpp::traits::input_parameter< const int >::type num_nearest(num_nearestSEXP);
    Rcpp::traits::input_parameter< const std::string >::type x_id(x_idSEXP);
    Rcpp::traits::input_parameter< const std::string >::type y_id(y_idSEXP);
    Rcpp::traits::input_parameter< const std::string >::type x_lon_col(x_lon_colSEXP);
    Rcpp::traits::input_parameter< const std::string >::type x_lat_col(x_lat_colSEXP);
...
// dist_weighted_mean
Rcpp::DataFrame dist_weighted_mean(Rcpp::DataFrame x_df, Rcpp::DataFrame y_df, const std::string& measure_col, const std::string& x_id, const std::string& x_lon_col, const std::string& x_lat_col, const std::string& y_lon_col, const std::string& y_lat_col, const std::string& dist_function, const std::string& dist_transform, const double decay);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type x_df(x_dfSEXP);
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type y_df(y_dfSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type measure_col(measure_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type x_id(x_idSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type x_lon_col(x_lon_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type x_lat_col(x_lat_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type y_lon_col(y_lon_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type y_lat_col(y_lat_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type dist_function(dist_functionSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type dist_transform(dist_transformSEXP);
...
Rcpp::DataFrame popdist_weighted_mean(Rcpp::DataFrame x_df, Rcpp::DataFrame y_df, const std::string& measure_col, const std::string& x_id, const std::string& x_lon_col, const std::string& x_lat_col, const std::string& y_lon_col, const std::string& y_lat_col, const std::string& pop_col, const std::string& dist_function, const std::string& dist_transform, const double decay);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::string& >::type y_lon_col(y_lon_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type y_lat_col(y_lat_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type pop_col(pop_colSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type dist_function(dist_functionSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type dist_transform(dist_transformSEXP);
    Rcpp::traits::input_parameter< const double >::type decay(decaySEXP);
...
// dist_sum_inv
Rcpp::DataFrame dist_sum_inv(Rcpp::DataFrame x_df, Rcpp::DataFrame y_df, const std::string& x_id, const std::string& y_id, const std::string& x_lon_col, const std::string& x_lat_col, const std::string& y_lon_col, const std::string& y_lat_col, const std::string& dist_function, const std::string& dist_transform, const double decay, const double scale_units);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::string& >::type dist_transform(dist_transformSEXP);
    Rcpp::traits::input_parameter< const double >::type decay(decaySEXP);
    Rcpp::traits::input_parameter< const double >::type scale_units(scale_unitsSEXP);
